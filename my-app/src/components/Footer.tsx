...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-100 dark:bg-gray-900 text-black dark:text-gray-300 py-6 border-t border-white/10 dark:border-gray-700 transition-colors duration-300">
